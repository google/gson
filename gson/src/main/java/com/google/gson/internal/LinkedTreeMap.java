...
public final class LinkedTreeMap<K extends @Nullable Object, V extends @Nullable Object>
  ...
  public LinkedTreeMap(@Nullable Comparator<? super K> comparator, boolean allowNullValues) {
