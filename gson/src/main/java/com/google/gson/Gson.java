...
import com.google.gson.internal.bind.DateTimeTypeAdapters;
...
public final class Gson {
  ...
  Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingPolicy,
    ...
    factories.add(TypeAdapters.newFactory(Date.class, DateTimeTypeAdapters.DATE));
    factories.add(TypeAdapters.newFactory(java.sql.Date.class, DateTimeTypeAdapters.SQL_DATE));
    factories.add(TypeAdapters.newFactory(Timestamp.class, DateTimeTypeAdapters.TIMESTAMP));
    factories.add(TypeAdapters.newFactory(Time.class, DateTimeTypeAdapters.TIME));
