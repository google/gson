...
public final class Gson {
  ...
  /**
   * Gson object with default configuration. The default configuration has the following settings:
   *
   * <ul>
   ...
   * </ul>
   *
   * @deprecated Use singleton constant instead. Replaced by {@link #DEFAULT}
   */
  @Deprecated
  public Gson() {
    this(
