...
public class PrimitiveTest {
  ...
  public void testByteDeserializationLossy() {
    ...
    try {
      ...
      assertEquals(
          "java.lang.NumberFormatException: Expected an int but was 2147483648 at line 1 column 11 path $",
          e.getMessage());
    }
  }
  ...
  public void testIntSerialization() {
    ...
    assertEquals(Integer.toString(Integer.MIN_VALUE),
        gson.toJson(Integer.MIN_VALUE, Integer.class));
    assertEquals(Integer.toString(Integer.MAX_VALUE),
        gson.toJson(Integer.MAX_VALUE, Integer.class));
    // Should perform widening conversion
  ...
  public void testFloatSerialization() {
    ...
    assertEquals(Float.toString(Long.MAX_VALUE - 10L),
        gson.toJson(Long.MAX_VALUE - 10L, Float.class));
    // Should perform narrowing conversion
  ...
  public void testDoubleSerialization() {
    ...
    // (This widening conversion is actually lossy)
    assertEquals(Double.toString(Long.MAX_VALUE - 10L),
        gson.toJson(Long.MAX_VALUE - 10L, Double.class));
  }
  ...
  public void testStringsAsBooleans() {
    ...
    assertEquals(Arrays.asList(true, false, true, false, false),
        gson.<List<Boolean>>fromJson(json, new TypeToken<List<Boolean>>() {
        }.getType()));
  }
