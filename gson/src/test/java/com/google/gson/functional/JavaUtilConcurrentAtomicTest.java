 ...
 */
class JavaUtilConcurrentAtomicTest {
  private Gson gson;
  ...
  @Test
  void testAtomicLongWithStringSerializationPolicy() throws Exception {
  ...
  @Test
  void testAtomicIntegerArray() throws Exception {
  ...
  @Test
  void testAtomicLongArray() throws Exception {
  ...
  @Test
  void testAtomicLongArrayWithStringSerializationPolicy() throws Exception {
    Gson gson = new GsonBuilder()
        .setLongSerializationPolicy(LongSerializationPolicy.STRING)
        .create();
    AtomicLongArray target = gson.fromJson("['10', '13', '14']", AtomicLongArray.class);
