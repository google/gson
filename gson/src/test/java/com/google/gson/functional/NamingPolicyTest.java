...
class NamingPolicyTest {
  ...
  @Test
  void testGsonWithLowerCaseDotPolicySerialization() {
  ...
  @Test
  void testGsonWithLowerCaseDotPolicyDeserialiation() {
    Gson gson = builder.setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_DOTS).create();
  ...
  @Test
  void testGsonWithUpperCaseUnderscorePolicySerialization() {
  ...
  @Test
  void testGsonWithUpperCaseUnderscorePolicyDeserialiation() {
    Gson gson = builder.setFieldNamingPolicy(FieldNamingPolicy.UPPER_CASE_WITH_UNDERSCORES)
        .create();
    String target = "{\"SOME_CONSTANT_STRING_INSTANCE_FIELD\":\"someValue\"}";
    StringWrapper deserializedObject = gson.fromJson(target, StringWrapper.class);
  ...
  @Test
  void testDeprecatedNamingStrategy() throws Exception {
  ...
  @Test
  void testComplexFieldNameStrategy() throws Exception {
    Gson gson = new Gson();
