 ...
 */
class ProtosWithAnnotationsTest {
  private Gson gson;
  ...
  @Test
  void testProtoWithAnnotations_deserialize() {
  ...
  @Test
  void testProtoWithAnnotations_deserializeUnknownEnumValue() {
    String json = String.format("{  %n"
        + "   \"content\":\"UNKNOWN\"%n"
        + "}");
  ...
  @Test
  void testProtoWithAnnotations_deserializeUnrecognizedEnumValue() {
    String json = String.format("{  %n"
  ...
  @Test
  void testProtoWithAnnotations_deserializeWithEnumNumbers() {
    String json = String.format("{  %n"
        + "   \"content\":\"0\"%n"
        + "}");
  ...
  @Test
  void testProtoWithAnnotations_serialize() {
