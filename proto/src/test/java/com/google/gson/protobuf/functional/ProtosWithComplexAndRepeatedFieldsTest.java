 ...
 */
class ProtosWithComplexAndRepeatedFieldsTest {
  private Gson gson;
  ...
  @Test
  void testSerializeRepeatedFields() {
  ...
  @Test
  void testDeserializeRepeatedFieldsProto() {
  ...
  @Test
  void testSerializeDifferentCaseFormat() {
  ...
  @Test
  void testDeserializeDifferentCaseFormat() {
