...
ProGuard is a tool for 'shrinking' and obfuscating compiled classes, it removes methods and fields if
they appear to be unused or renames them. This can cause issues for Gson which uses Java reflection to
